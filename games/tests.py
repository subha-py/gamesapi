...
class GameCategoryTests(APITestCase):
    ...
    def test_create_duplicated_game_category(self):
        '''
        Ensure we cannot let two categories with same name
        '''
        new_game_category_name = 'New Game Category'
    ...
    def test_filter_game_category_by_name(self):
        ...
        '''
        new_game_category_name1 = 'First Game Category'
        self.create_game_category(new_game_category_name1)
        new_game_category_name2 = 'Second Game Category'
        self.create_game_category(new_game_category_name2)
        filter_by_name = {'name': new_game_category_name1}
        url = '{0}?{1}'.format(
        ...
        self.assertEqual(
            response.data['results'][0]['name'],
            new_game_category_name1
        )


class PlayerTests(APITestCase):

    def create_player(self,name,gender=Player.MALE):
    ...
    def test_duplicate_player(self):
        '''
        Ensure no two players with same name exists
        '''
